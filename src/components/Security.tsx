const points = [
  ...
  {
    title: "Tink-certificeret",
    description:
      "Vi bruger Tink (ejet af Visa) — samme teknologi som de store banker bruger. PSD2-reguleret og godkendt af Finanstilsynet.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Vi bruger Tink (ejet af Visa) til bankforbindelse — den samme
            teknologi som Nordens største banker stoler på.
          </p>
        </div>
