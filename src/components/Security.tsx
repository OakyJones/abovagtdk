const points = [
  ...
  },
  {
    ...
    description:
      "Vi bruger GoCardless (Nordigen), en PSD2-reguleret open banking-udbyder med egen AISP-licens i EU. Vi har kun læseadgang til dine transaktioner — vi kan aldrig flytte penge.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Vi bruger GoCardless (Nordigen), en PSD2-reguleret open banking-udbyder med egen
            AISP-licens i EU. Vi har kun læseadgang — vi kan aldrig flytte penge.
          </p>
        </div>
