    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-50/30 to-white">
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div>
          ...
          {/* Open banking trust box */}
          <div className="mt-8 bg-gray-50 rounded-2xl border border-gray-200 p-5">
            <div className="flex items-center gap-3 mb-3">
              <span className="text-xl">🔒</span>
              <span className="text-sm font-bold text-[#1C2B2A]">Sikker open banking (PSD2)</span>
            </div>
            <p className="text-sm text-gray-600 leading-relaxed">
              Din bankforbindelse h&aring;ndteres via reguleret open banking (PSD2).
              Vi kan kun l&aelig;se dine transaktioner &mdash; aldrig flytte penge eller se din saldo.
            </p>
            <a
              href="/sikkerhed"
          ...
          <div className="mt-5 space-y-3">
            {[
              ...
              "Sikker bankforbindelse via open banking (kun l\u00e6seadgang)",
