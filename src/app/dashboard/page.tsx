          ...
          <div className="max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-gray-600 text-sm">
                Vi reserverer 35 kr. Finder vi abonnementer betaler du 35 kr — ellers gratis.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5 mb-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  { num: "4", text: "Finder vi abonnementer betaler du 35 kr — ellers gratis" },
                ].map((s) => (
            ...
            {totalSavings > 0 && !hasPaid && (
              <div className="relative bg-teal-50 rounded-2xl border-2 border-[#1B7A6E] p-6 sm:p-8 mb-8">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-5 mt-2">
                  <div className="space-y-3">
                    ...
                    <div className="border-t border-gray-200 pt-3 flex items-center justify-between">
                      ...
                      <span className="text-lg font-bold text-[#1B7A6E]">{(totalSavings - fee).toLocaleString("da-DK")} kr/md &mdash; hvis du opsiger de valgte</span>
                    </div>
                  </div>
                </div>
                <button
                ...
                <p className="mt-4 text-center text-xs text-gray-500">
                  Vi tr&aelig;kker {fee} kr af de {cardReserved ? "45" : fee} kr der er reserveret. Resten frigives.
                </p>
              </div>
            )}
          ...
          <div className="max-w-lg mx-auto">
            <div className="text-center mb-8">
              <Inspektoeren
                pose="thumbsup"
                size={120}
                speechBubble={`Du betaler ${fee} kr — tak fordi du bruger AboVagt!`}
                className="mb-4"
              />
              <h1 className="text-2xl sm:text-3xl font-bold text-[#1C2B2A]">
                ...
                <div className="border-t border-[#1B7A6E]/20 pt-3">
                  ...
                  {fee < 35 && (
                    <div className="flex items-center justify-between mt-1">
                      ...
                      <span className="text-sm text-gray-500">{35 - fee} kr</span>
                    </div>
                  )}
                </div>
              </div>
